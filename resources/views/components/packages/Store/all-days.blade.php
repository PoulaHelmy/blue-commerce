<div class="card card-success">
    ...
    <input type="hidden" id="daysCount" name="daysCount" value="1">
    <div class="card-body " id="days-card-body">
        <div class="card card-success" id="days-single-day-1">
                ...
                <div class="row days">
                    ...
                    <div class="form-group col-2">
                        ...
                        <input type="number" class="form-control"
                               name="days[1][order]"
                               min="1"
                               id="order-1" value="{{old('days[1][order]')}}"
                               required
                    ...
                    <div class="form-group col-10">
                        ...
                        <input type="text" class="form-control" name="days[1][title]"
                               id="day-1-title"
                               value="{{old('days[1][title]')}}"
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea name="days[1][summery]" class="form-control"
                                  id="day-1-summery">{{old('days[1][summery]')}}</textarea>
                    </div>
                    <!---- DAY Gallery --->
                    <div class="form-group col-12">
                        <div class="card card-dark">
                            ...
                            <div class="card-body" id="single-days-gallery-1">
                                <input type="hidden" id="dayOneCountss" name="dayOneCountss" value="1">
                                <div class="row" id="single-days-images-1">
                                    <div class="form-group col-lg-6">
                                        <label for="exampleInputFile">Image </label>
                                        <div class="input-group">
                                            <input type="text" id="single-day-images-1-image"
                                                   class="form-control"
                                                   name="days[1][gallery][1][image]" required
                                                   placeholder="Slider Image "
                                                   aria-describedby="button-slider">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button"
                                                        id="button-single-day-images-1-image"
                                                        data-input="single-day-images-1-image">Select
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-5">
                                        ...
                                        <input type="text" class="form-control" name="days[1][gallery][1][alt]"
